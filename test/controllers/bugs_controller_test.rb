...
class BugsControllerTest < ActionController::TestCase
  ...
  test "should create bug" do
    assert_difference('Bug.count') do
      post :create, bug: { description: @bug.description, status: @bug.status, title: @bug.title, user_id: @bug.user_id }
    end
  ...
  test "should update bug" do
    patch :update, id: @bug, bug: { description: @bug.description, status: @bug.status, title: @bug.title, user_id: @bug.user_id }
    assert_redirected_to bug_path(assigns(:bug))
  end
